...
exports.Chats = function () {
    var _a = react_1.useState(defaultMessages), messages = _a[0], setMessages = _a[1];
    var chatId = react_router_dom_1.useParams().chatId;
    var Item = styles_1.styled(Paper_1["default"])(function (_a) {
        var theme = _a.theme;
        return (__assign(__assign({ backgroundColor: theme.palette.mode === 'dark' ? '#1A2027' : '#fff' }, theme.typography.body2), { padding: theme.spacing(1), textAlign: 'left', color: theme.palette.text.secondary }));
    });
    var sendMessage = react_1.useCallback(function (_a) {
        var text = _a.text, author = _a.author;
        setMessages(function (prevMessages) {
            var _a;
            return __assign(__assign({}, prevMessages), (_a = {}, _a["chat" + chatId] = __spreadArrays(prevMessages["chat" + chatId], [
                {
                    id: nanoid_1.nanoid(),
                    author: author,
                    text: text
    ...
    react_1.useEffect(function () {
        var _a;
        if (((_a = messages["chat" + chatId]) === null || _a === void 0 ? void 0 : _a.length) &&
        ...
        react_1["default"].createElement(Grid_1["default"], { container: true, spacing: 2 },
            react_1["default"].createElement(Grid_1["default"], { item: true, xs: 4 },
                react_1["default"].createElement(Item, null,
                    react_1["default"].createElement(MessageList_1.MessageList, { messages: messages["chat" + chatId] })),
                react_1["default"].createElement(Item, null,
                    react_1["default"].createElement(Form_1.Form, { addMessage: sendMessage }))),
            react_1["default"].createElement(Grid_1["default"], { item: true, xs: 4 },
                react_1["default"].createElement(Item, null,
                    react_1["default"].createElement(ChatList_1.ChatList, { chats: chats }))))));
};
